/* START OF BOARD PRESET: Default (CC0) */
const phrasesDefault = ["Default (CC0)"];
...
phrasesCboardClassic.push(["Food: Vegetables", "vegetables", "salad", "potato", "mash potato", "sweet potato", "rice", "baked beans", "sweetcorn", "beetroot", "carrot", "tomato", "cucumber", "cabbage", "onion", "spring onions", "pepper", "chili pepper", "lettuce", "asparagus", "radish", "aubergine", "broccoli", "peas", "avocado", "green beans", "spinach", "pumpkin", "brussel sprouts"]);
phrasesCboardClassic.push(["Food: Fruit", "strawberry", "apple", "apricot", "peach", "mango", "pear", "orange", "melon", "banana", "kiwi", "pineapple", "watermelon", "cherry", "grapefruit", "grapes"]);
...
phrasesCboardClassic.push(["Snacks", "I want", "[SEP]", "ice cream", "chocolate", "crisps", "marshmallows", "biscuits", "jelly beans", "candy cane", "nuts", "cake slice", "chocolate chip biscuit", "yogurt", "ice lolly", "pretzel", "peanut"]);
...
phrasesCboardClassic.push(["Body: Medical", "I am", "I have", "I need", "[SEP]", "back ache", "headache", "stomach ache", "toothache", "inhaler", "rash", "operation", "plaster", "medicine", "xray", "surgery health center", "syringe", "tablets", "blood pressure", "cut", "oxygen mask", "to vomit", "thermometer"]);
...
phrasesCboardClassic.push(["People: Characters", "fairy", "ghost", "elf", "witch", "monster"]);
...
phrasesCboardClassic.push(["Shapes", "circle", "oval", "triangle equilateral", "square", "rectangle", "pentagon", "hexagon", "octagon", "star", "diamond", "pyramid triangular base"]);
...
phrasesCboardClassic.push(["Insects", "snail", "beetle", "honey bee", "ant", "cricket", "moth", "butterfly", "fly", "dragonfly", "earwig", "slug", "wasp", "beehive", "bees nest", "caterpillar"]);
...
phrasesCboardClassic.push(["Sports", "judo", "tennis", "basketball", "cricket", "baseball bat", "badminton", "golf", "archery", "to ski", "to swim", "darts", "pool snooker", "to ride horse", "bowling", "boccia", "volleyball", "olympic rings", "para olympic games", "olympic torch", "golf", "race athletics"]);
phrasesCboardClassic.push(["Transport", "Let's go by", "I went by", "[SEP]", "car", "bicycle", "wheelchair", "motorcycle", "bus", "taxi", "aeroplane", "helicopter", "train", "mini bus", "ferry", "boat", "tractor", "skateboard", "army tank", "hot air balloon", "fire engine", "spaceship", "rocket", "Jeep", "ambulance", "police car", "van", "transport", "lorry", "refuse lorry"]);
