...
const phrasesDefaultAr = ["Default (CC0) [MT:ar]"]; //FIXME 2 quotes short
phrasesDefaultAr.push(["Common", "نعم", "لا", "تمام", "[SEP]",
			"لا أعرف", "لا أفهم", "[SEP]",
			"ماذا؟", "لماذا؟", "كيف؟", "[SEP]",
			"متى؟", "أي؟", "أين؟", "[SEP]",
			"جيد", "سيء", "توقف!", "[SEP]",
			"مرحبا", "وداعا", "سعيد " + new Date().toLocaleString(document.language, {weekday:'long'}), "[SEP]",
			"من فضلك", "شكرا", "[SEP]",
			"أمس", "اليوم", "غدا", "[SEP]",
			"يوم", "ليل", "صباح", "بعد الظهر", "[SEP]",
			"أنا جائع", "أنا عطشان", "أنا متعب", "أحتاج إلى الحمام", "[SEP]"
			]);
phrasesDefaultAr.push(["Numbers", "0", "1", "2", "3", "4", "[SEP]", "5", "6", "7", "8", "9"]);
phrasesDefaultAr.push(["Foods", "أريد", "أحتاج", "[SEP]", "بسكويت", "خبز", "بروكلي", "برجر", "حبوب", "دجاج", "ذرة", "بيض", "بطاطس مقلية", "شطيرة جبن مشوي", "بطاطا هاش براون", "هوت دوج", "ماك آند تشيز", "فطائر", "معكرونة", "زبدة الفول السوداني والهلام", "بيتزا", "بطاطس", "رامن", "أرز", "سندويتش", "نقانق", "حساء", "فاصوليا خضراء", "توست", "وافلز"]);
phrasesDefaultAr.push(["Snacks", "أريد", "أحتاج", "[SEP]", "بسكويت براوني", "كعكة", "حلويات", "رقائق", "كوكيز", "مقرمشات", "دوناتس", "آيس كريم", "مافن", "مكسرات", "فطيرة", "بريتزل"]);
phrasesDefaultAr.push(["Drinks", "أريد", "أحتاج", "[SEP]", "ماء", "عصير", "قهوة", "شوكولاتة ساخنة", "حليب", "صودا", "ميلك شيك", "قشة"]);
phrasesDefaultAr.push(["Places", "خارج", "داخل", "منزل", "فناء أمامي", "فناء خلفي", "ترس", "مرآب", "متجر بقالة", "محطة وقود", "مستشفى", "مكتب", "مدرسة", "بنك", "صراف آلي", "جيم"]);
phrasesDefaultAr.push(["Fun", "بآآآ", "شوش شوش شوش", "كيف الآن بقرة بنية"]);
boardPresets.push(phrasesDefaultAr);
/* END OF BOARD PRESET */
...
/* START OF BOARD PRESET */
const phrasesCboardClassicAr = ["Cboard Classic Home (GPL-3.0) [MT:ar]"]; //FIXME 34 quotes short
phrasesCboardClassicAr.push(["Common", "نعم", "لا", "مرحبا", "وداعا", "جيد", "سيء", "لا أستطيع التحدث", "شكرا لك", "من فضلك"]);
phrasesCboardClassicAr.push(["Time", "وقت", "الآن", "أمس", "اليوم", "غدا", "الصباح", "بعد الظهر", "الليل", "اليوم", "هذا الأسبوع", "نهاية الأسبوع", "الأسبوع القادم", "هذا الشهر", "الشهر القادم", "الشهر الماضي", "ساعة", "دقيقة", "ثانية"]);
phrasesCboardClassicAr.push(["Food", "طعام", "أنا جائع", "أريد", "و", "لا أحب", "[SEP]", "حساء", "خضروات", "فاكهة", "بيتزا", "خبز", "بيضة مسلوقة", "بيضة مقلية", "كرواسون", "حبوب", "دقيق الشوفان", "فطائر", "معكرونة", "دواجن", "لحم بقري", "سمك", "سباغيتي بولونيز", "برجر", "هوت دوج", "فطيرة", "مطحنة فلفل", "ملح", "صلصة طماطم", "خل", "ساندويتش", "خبز محمص", "جبن", "معكرونة", "رقائق بطاطس"]);
phrasesCboardClassicAr.push(["Food: Soup", "حساء", "حساء جزر", "حساء دجاج", "حساء فطر", "حساء بصل", "حساء بازلاء", "حساء طماطم", "حساء خضار"]);
phrasesCboardClassicAr.push(["Food: Vegetables", "خضروات", "سلطة", "بطاطس", "بطاطا مهروسة", "بطاطا حلوة", "أرز", "فاصوليا", "ذرة حلوة", "شمندر", "جزر", "طماطم", "خيار", "كرنب", "بصل", "بصل أخضر", "فلفل", "فلفل حار", "خس", "بروكلي", "بازلاء", "أفوكادو", "فاصوليا خضراء", "سبانخ", "قرع اليقطين", "براسل سبراوت"]);
phrasesCboardClassicAr.push(["Food: Fruit", "فراولة", "تفاح", "خوخ", "برقوق", "مانجو", "كمثرى", "برتقال", "بطيخ", "موز", "كيوي", "أناناس", "watermelon", "كرز", " grapefruit", "عنب"]);
phrasesCboardClassicAr.push(["Drinks", "أنا عطشان", "أريد", "لا أحب", "[SEP]", "شراب", "ماء", "عصير برتقال", "عصير تفاح", "عصير عنب", "عصير أبيض العنب", "عصير الأناناس", "عصير ليمون", "حليب", "ميلك شيك", "شوكولاتة ساخنة", "شاي", "قهوة", "نبيذ", "بيرة", "قش"]);
phrasesCboardClassicAr.push(["Snacks", "أريد", "[SEP]", "آيس كريم", "شوكولاتة", "رقائق", "مارشميلو", "بسكويت", "حلوى جيلي", "عصا حلوى", "مكسرات", "شريحة كعكة", "بسكويت رقائق الشوكولاتة", "زبادي", "مصاصة ثلج", "بريتزل", "فول سوداني"]);
phrasesCboardClassicAr.push(["Activities", "أريد", "[SEP]", "ركوب الدراجة", "لعب كرة السلة", "لعب البولينج", "لعب ألعاب الكمبيوتر", "مشاهدة التلفزيون", "حل لغز الصور المقطوعة", "لعب كرة القدم", "لعب البينغو", "الاستحمام", "العمل", "الطبخ", "ممارسة الرياضة", "الجري", "المصارعة", "الاحتفال", "السباحة", "صيد الأسماك", "رمي السهام", "لعب الورق"]);
phrasesCboardClassicAr.push(["Emotions", "أنا", "أنت", "هل أنت", "[SEP]", "سعيد", "حزين", "غاضب", "خائف", "مربك", "ساخن", "بارد", "متحمس", "مسترخي"]);
phrasesCboardClassicAr.push(["Body", "لدي ألم في", "[SEP]", "حكة", "الرأس", "الوجه", "الرقبة", "الكتف", "الذراعين", "اليد اليمنى", "اليد اليسرى", "الكوع", "الظهر", "المعدة", "الإصبع", "الساق", "القدم", "الحلق", " الورك", "الأسفل", "الإبهام", "أظفر القدم", "أظفر الإصبع", "العضلات", "الجلد", "العظام", "الركبة"]);
phrasesCboardClassicAr.push(["Body: Face", "وجه", "حاجب", "عيون", "عين", "رموش", "خد", "أذن", "شفاه", "أسنان", "لثة", "لسان", "ذقن"]);
phrasesCboardClassicAr.push(["Body: Medical", "أنا", "لدي", "أحتاج", "[SEP]", "ألم الظهر", "صداع", "ألم في المعدة", "وجع الأسنان", "حاوي استنشاق", "طفح جلدي", "عملية", "ضمادة", "دواء", "صورة بالأشعة السينية", "مركز صحي جراحي", "حقنة", "أقراص", "ضغط الدم", "قطع", "قناع الأكسجين", "لتقيؤ", "ميزان حرارة"]);
phrasesCboardClassicAr.push(["Clothing", "قميص", "تي شيرت", "بنطلون", "شورت", "سترة", "معطف", "بلوزة", "فستان", "جوارب", "سويت شيرت", "تنورة", "وست", "بيجامة"]);
phrasesCboardClassicAr.push(["Clothing: Accessories", "نظارات", "نظارات شمسية", "غطاء رأس", "قبعة", "ربطة عنق", "ربطة عنق", "جوارب", "قفازات", "أحذية", "حمالة صدر", "سراويل قصيرة", "بنطلون", "محفظة", "مجوهرات", "صندل", "أحذية رياضية", "وشاح", "مظلة", "ساعة"]);
phrasesCboardClassicAr.push(["Colours", "أسود", "أبيض", "أرجواني", "أصفر", "وردي", "أزرق", "أخضر", "أحمر"]);
phrasesCboardClassicAr.push(["People", "أبي", "أمي", "معلم", "طبيب", "ممرض", "علاج النطق واللغة", "شرطة", "مندوب توصيل", "مندوب بريد", "طبيب أسنان", "نجار", "سكرتير", "سائق سيارة أجرة", "حداد", "مساعد تكنولوجيا المعلومات"]);
phrasesCboardClassicAr.push(["People: Family", "أنا", "لك", "[SEP]", "عائلة", "جد", "جدة", "أمي", "أبي", "أخت", "أخ", "ابنة", "ابن", "طفل"]);
phrasesCboardClassicAr.push(["People: Characters", "جنية", "شبح", "قزم", "ساحرة", "وحش"]);
phrasesCboardClassicAr.push(["Describe", "أنا", "إنه", "أنت", "لا", "[SEP]", "قبيح", "جميل", "كبير", "صغير", "نفس", "قديم", "سريع", "قذر", "هادئ", "صاخب", "سمين", "نحيف", "طويل", "قصير", "طويل", "فارغ", "ممتلئ", "عميق", "ضحل", "مفتوح", "مغلق", "ثقيل", "خفيف", "مكسور", "ناعم", "صلب", "مجعد", "سميك", "لامع", "متطور", "صاخب", "جاف", "رطب", "لذيذ"]);
phrasesCboardClassicAr.push(["Shapes", "دائرة", "بيضاوية", "مثلث متساوي الأضلاع", "مربع", "مستطيل", "خماسي", "سداسي", "مربع", "نجمة", "معين", "هرم ذو قاعدة مثلثة"]);
phrasesCboardClassicAr.push(["Kitchen", "أين", "أحتاج", "أنا", "[SEP]", "شوكة", "سكين", "ملعقة", "طبق", "كوب شرب", "كوب", "قش", "منشفة ورقية", "وعاء", "مفرش مائدة", "مدقة", "ثلاجة", "مئزر"]);
phrasesCboardClassicAr.push(["School", "قلم", "قلم رصاص", "ممحاة", "حافظة أقلام", "حقيبة مدرسية", "دفتر ملاحظات", "ملف على شكل حلقات", "آلة حاسبة", "مقص", "سبورة", "معلم", "مصحح", "أقلام تلوين", "غراء", "دباسة"]);
phrasesCboardClassicAr.push(["School: Class Room", "درس الجبر", "درس الفن", "درس الدراما", "درس اللغة الإنجليزية", "درس الجغرافيا", "درس التاريخ", "درس الرياضيات", "درس تكنولوجيا المعلومات", "درس الموسيقى", "درس العلوم", "لا يوجد درس"]);
phrasesCboardClassicAr.push(["Animals", "لدي", "رأيت", "أريد", "[SEP]", "كلب", "قطة", "هامستر", "أرنب", "قنفذ", "حصان", "حمار", "ضفدع", "خروف", "قفص للكلاب", "قفص", "حظيرة", "ضفدع", "كتاكيت", "سمك", "دجاج حي", "فأر", "جرذ", "ببغاء", "عش", "إوزة", "بقرة", "سلاحف", "جمال", "خنزير صغير"]);
phrasesCboardClassicAr.push(["Animals: Wild", "نمر", "فيل", "زرافة", "قرد شمبانزي", "ثعبان", "ثعبان سام", "باندا", "حصان النهر", "دب", "دب قطبي", "ثعلب", "أسد", "ذئب", "شمبانزي", "إيل", "زيبرا", "كنغر", "خفاش", "كوالا", "وحيد القرن", "ديناصور", "قط", "أكل النمل", "غزال", "نملة"]);
phrasesCboardClassicAr.push(["Animals: Marine", "سمكة البحرية", "بطريق", "نجمة البحر", "دولفين", "فقمة", "حوت القاتل", "سرطان البحر", "سمكة ذهبية", "بلح البحر", "جمبري", "تمساح", "قنديل البحر", "فقمة", "سمك الببغاء"]);
phrasesCboardClassicAr.push(["Animals: Birds", "بومة", "نسر", "خاطف", "حمامة", "ببغاء", "كتاكيت", "دجاج حي", "بطة", "إوزة", "بلشون", "روبن", "ديك رومي", "طائر", "بطريق", "فلامنغو", "طاووس", "ديك", "ببغاء"]);
phrasesCboardClassicAr.push(["Insects", "حلزون", "خنافس", "نحلة", "نملة", "عCricket", "عث", "فراشة", "ذباب", "عنكبوت", "أذن", "سلحفاة", "وسواس", "خلية نحل", "عش النحل", "دودة"]);
phrasesCboardClassicAr.push(["Technology", "أحتاج", "أين", "أنا", "لك", "[SEP]", "كمبيوتر", "لابتوب", "شاحن كهربائي", "بطارية", "كاميرا", "سماعات رأس", "بلاي ستيشن", "ذاكرة فلاش USB", "طابعة", "ماوس الكمبيوتر", "iPod", "iPhone", "ستيريو", "مشغل DVD", "Wii", "جهاز التحكم عن بعد", "لوحة مفاتيح الكمبيوتر", "سلك تمديد"]);
phrasesCboardClassicAr.push(["Weather", "مطر", "شمس", "ثلج", "عاصفة رعدية", "غائم", "الخريف", "الشتاء", "الربيع", "الصيف"]);
phrasesCboardClassicAr.push(["Plants", "نبات في أصيص", "شجرة", "فرع", "ورقة", "جذع الشجرة", "عشب", "سلحفاة", "شجيرة", "زهرة", "زهرة الأقحوان", "زهرة الزنبق", "وردة", "زهرة الزنبق", "بتلات", "بذور", "عصا", "جذور", "كرمة", "حقل", "الحياة الفطرية", "أكو", "صبار", "مخروط صنوبري"]);
phrasesCboardClassicAr.push(["Sports", "جودو", "كرة المضرب", "كرة السلة", "كريكت", "مضرب بيسبول", "كرة الريشة", "غولف", "رماية", "للتزلج", "للسباحة", "الرمي السهام", "البولينج", "ركوب الخيل", "البينغو", "بوشيا", "كرة القدم", "الحلقات الأولمبية", "الألعاب البارالمبية", "شعلة أولمبية", "غولف", "ركض المسافات المتوسطة"]);
phrasesCboardClassicAr.push(["Transport", "دعنا نذهب بال", "ذهبت بال", "[SEP]", "سيارة", "دراجة", "كرسي متحرك", "دراجة نارية", "حافلة", "سيارة أجرة", "طائرة", "مروحية", "قطار", "ميني باص", "عبارة", "قارب", "جرار", "لوح تزلج", "دبابة", "منطاد الهواء الساخن", "سيارة إطفاء", "مركبة فضائية", "صاروخ", "جيب", "سيارة إسعاف", "سيارة شرطة", "van", "نقل", "شاحنة"]);
phrasesCboardClassicAr.push(["Places", "منزل", "متجر", "بنك", "مبنى مكاتب", "في الخارج", "شاطئ", "صالة ألعاب رياضية", "كنيسة", "حقل", "حديقة خلفية", "مدرسة", "مركز صحي جراحي", "مرآب", "مسبح"]);
phrasesCboardClassicAr.push(["Position", "في", "خارج", "على", "تحت", "فوق", "خلف", "أمام", "من خلال", "بين", "أعلى", "أسفل", "يسار", "يمين", "حول", "إلى الأمام", "للخلف", "قبل", "بعد"]);
phrasesCboardClassicAr.push(["Toys", "أريد", "أحب", "أين", "لك", "أنا", "[SEP]", "دب تيدي", "دمية", "لغز الشكل", "سيارة لعبة", "جندي لعبة", "هاتف لعبة", "مكعبات", "كرة", "فقاعات", "طائرة ورقية", "ألعاب طين", "دمية", "خرز", "ليغو", "ترامبولين", "ألعاب"]);
phrasesCboardClassicAr.push(["Actions", "للحصول على", "لإعطاء", "لوضع", "للسماع", "للمجيء", "للذهاب", "للانتظار", "لأخذ", "للمشاهدة", "للتفكير", "لجعل", "لتحطيم", "للنوم", "للاستيقاظ", "للتحدث", "للصراخ", "لجلب", "لتحريك", "للسقوط", "للوقف", "للجلوس", "للمشاركة", "لحمل", "للحفاظ", "للقفز", "للمطاردة", "للتسلق", "للزحف", "للهبوط", "للدخول من الباب", "للخروج من الباب", "للاستراحة", "للاعتقال", "للعثور على", "لضرب الكرة", "للدراسة", "لتغيير رأي المرء", "للاعتصاف"]);
phrasesCboardClassicAr.push(["Questions", "ماذا", "لماذا", "كيف", "كم", "متى", "أي", "أين"]);
phrasesCboardClassicAr.push(["Furniture", "كرسي", "طاولة", "كرسي طفل", "كرسي هزاز", "طاولة قهوة", "حصيرة", "خزانة زاوية", "خزانة ملابس", "درج", "باب", "نافذة", "رف كتب", "خزانة كتب", "مسند", "حقيبة فاصوليا", "طاولة طعام", "ستائر", "سرير واحد", "بطانية", "مصباح", "صورة"]);
phrasesCboardClassicAr.push(["Hygiene", "فرشاة أسنان", "معجون أسنان", "صابون", "منشفة", "مشط", "قصافة أظافر", "منشفة ورقية", "وسادة صحية", "المناديل", "شامبو", "جل ما بعد الحلاقة", "حلاقة كهربائية", "مرطب شعر", "مكياج", "مزيل العرق", "ورق التواليت", "مجفف الشعر", "صبغة الشعر"]);
phrasesCboardClassicAr.push(["Numbers", "0", "1", "2", "3", "4", "[SEP]", "5", "6", "7", "8", "9"]);
boardPresets.push(phrasesCboardClassicAr);
/* END OF BOARD PRESET */
