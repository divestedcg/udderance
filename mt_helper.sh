ollama run gemma3:12b-it-qat "Please translate the following quoted strings to Spanish, keep the identical format, and do not say anything else: $(cat /home/admin/default)" > default-es
ollama run gemma3:12b-it-qat "Please translate the following quoted strings to German, keep the identical format, and do not say anything else: $(cat /home/admin/default)" > default-de
ollama run gemma3:12b-it-qat "Please translate the following quoted strings to French, keep the identical format, and do not say anything else: $(cat /home/admin/default)" > default-fr
ollama run gemma3:12b-it-qat "Please translate the following quoted strings to Hindi, keep the identical format, and do not say anything else: $(cat /home/admin/default)" > default-hi
...
ollama run gemma3:12b-it-qat "Please translate the following quoted strings to French, keep the identical format, and do not say anything else: $(cat /home/admin/cboard)" > cboard-fr
ollama run gemma3:12b-it-qat "Please translate the following quoted strings to Hindi, keep the identical format, and do not say anything else: $(cat /home/admin/cboard)" > cboard-hi
